...
class Curso
{
    ...
    public function crud($opcao){
        try { //tentar executar o código
            ...
            $sql = "Call crud_curso(?,?,?)"; //coloca interrogação no lugar dos dados, quando for salvar e excluir tem que receber id, salvar é nulo
            ...
            $exec->bindValue(2, mb_strtoupper($this->nome)); // Esse strtoupper deixa maiusculo, controlando pra não chegar de qualquer jeito no formularioo strtoupper sozinho, sem o mb, não aumenta o ç e outros
            $exec->bindValue(3, $opcao); ///não tem this porque não é atributo da classe, esse atributo vai ser disparado principalmente pro editar
